...
use syn::{
    Attribute, Data, DeriveInput, Error, Expr, Field, Fields, FieldsNamed, FieldsUnnamed,
    GenericParam, Generics, Ident, PredicateType, Result, Token, TraitBound, Type, TypeMacro,
    TypeParamBound, TypePath, WhereClause, WherePredicate, braced, punctuated, token,
};
